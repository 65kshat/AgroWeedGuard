...
st.set_page_config(page_title="AgroWeedGuard", page_icon="🌱", layout="wide")
...
with col1:
    st.metric(label="Detection Models", value="2")

with col2:
    st.metric(label="Classification Models", value="2")

with col3:
    st.metric(label="Weed Classes", value="12")

with col4:
    st.metric(label="AI Models Total", value="4")
